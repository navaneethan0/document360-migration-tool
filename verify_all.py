...
def list_all_articles():
    ...
    if not api_token or not project_version_id:
        print("Error: Required environment variables not found in .env")
        return

    # Endpoint to get all articles in a project version
    url = f"{base_url}/v2/ProjectVersions/{project_version_id}/articles"
    headers = {"api_token": api_token}

    print(f"Listing all articles in version {project_version_id}...")
